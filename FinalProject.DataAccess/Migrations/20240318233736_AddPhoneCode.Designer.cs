...
namespace FinalProject.Migrations
{
    ...
    [Migration("20240318233736_AddPhoneCode")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject.Domain.Models.JobPostAndContract.ApplyTask", b =>
                {
                    b.HasOne("FinalProject.Domain.Models.ApplicationUserModel.ApplicationUser", null)
                        .WithMany("ApplyTasks")
            ...
            modelBuilder.Entity("FinalProject.Domain.Models.JobPostAndContract.JobPost", b =>
                {
                    b.HasOne("FinalProject.Domain.Models.SkillAndCat.Category", "Category")
                        .WithMany("JobPosts")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinalProject.Domain.Models.ApplicationUserModel.ApplicationUser", "ApplicationUser")
                        .WithMany("JobPosts")
            ...
            modelBuilder.Entity("FinalProject.Domain.Models.JobPostAndContract.JobPostSkill", b =>
                {
                    ...
                    b.HasOne("FinalProject.Domain.Models.SkillAndCat.Skill", "Skill")
                        .WithMany("JobPostSkill")
            ...
            modelBuilder.Entity("FinalProject.Domain.Models.NotificationAndMessageModel.Notification", b =>
                {
                    b.HasOne("FinalProject.Domain.Models.JobPostAndContract.ApplyTask", "ApplyTask")
                    ...
                    b.HasOne("FinalProject.Domain.Models.ApplicationUserModel.ApplicationUser", "User")
                        .WithMany("Notifications")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FinalProject.Domain.Models.RatingModel.Review", b =>
                {
                    ...
                    b.HasOne("FinalProject.Domain.Models.JobPostAndContract.ApplyTask", "ApplyTask")
                        .WithOne("Review")
                        .HasForeignKey("FinalProject.Domain.Models.RatingModel.Review", "ApplyTaskId");
            ...
            modelBuilder.Entity("FinalProject.Domain.Models.RegisterNeeded.ApplicationUserLanguage", b =>
                {
                    ...
                    b.HasOne("FinalProject.Domain.Models.RegisterNeeded.Language", "Language")
                        .WithMany("UserLanguages")
